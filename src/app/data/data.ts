import { ContactDetails, Solution, Sector, NumberData, Customer, IdentitySigns, Honor, HowElement } from "../models/data.models"
...
export const solutions: Solution[] = [
    {  name: 'Rotulación', 
        ...
        text: ['Además de diseñar, producir e instalar múltiples tipos de rótulos, distribuimos los materiales necesarios para ello.',
...
{  name: 'Digital Signage', 
    description: 'Fabricamos, distribuimos e instalamos todo tipo de pantallas publicitarias de LED y LCD así como cajas de luz, tanto para interior como para fachadas y escaparates.',
    text: ['Disponemos de una vasta oferta de pantallas para publicidad en punto de venta compuesta por los modelos más novedosos del mercado.', 
    ...
    { name: 'Diseño corporativo', 
        ...
        text: ['Si necesitas comenzar el proceso desde los cimientos, diseñaremos y desarrollaremos una identidad visual corporativa coherente con tus productos o servicios y tus objetivos.', 
...
{  name: 'Mobiliario y decoración', 
    ...
    text: ['Creamos y distribuimos mostradores, asientos, expositores y elementos decorativos para transformar espacios.', 
...
{  name: 'Iluminación', 
    ...
    text: ['La iluminación es uno de los puntos más importantes y olvidados a la hora de diseñar espacios comerciales.', 
    ...
    { name: 'Aluminio',
        description: 'Distribuimos perfiles de aluminio, planchas para fachadas, paneles decorativos, etc.',
            text: ['Trabajamos el aluminio en todas sus facetas, desde perfiles para ventanas o mobiliario hasta paneles calados decorativos o separadores de ambientes.', 
...
export const sectors: Sector[] = [
    {  name: 'Restaurantes', image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1729257345/dise%C3%B1o-y-construccion-restaurantes-botong-sign_pdhuia.webp', 
        text: ['En Botong Sign contamos con amplia experiencia en el diseño y producción de mobiliario y dispositivos inteligentes para la hostelería.',
    ...
    {  name: 'Joyerías', image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1729257345/dise%C3%B1o-y-construccion-joyerias-botong-sign_q7kdfk.webp', 
        text:['Además de los materiales comunes a otro tipo de establecimientos, Botong Sign destaca en el sector joyero por su gama de cerraduras electrónicas inteligentes.', 
    ...
    {  name: 'Concesionarios', image: 'https://res.cloudinary.com/dxuseyfxa/image/upload/v1729257344/dise%C3%B1o-y-construccion-concesionario-botong-sign_warbaq.webp', 
        text: ['Otro de los sectores que más demandan los servicios de Botong Sign es el de la automoción.',
